          ...
          <CardContent>
            <Table>
              <TableRow>
                ...
                <TableCell>{row.Last_upgrade_time}</TableCell>
              </TableRow>
              <TableRow>
    ...
    <Card sx={{ width: 500, boxShadow: 3, m: 1 }}>
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary">
          <List>
            <ListItem>
              <ListItemText>License expiring in 3 Weeks</ListItemText>
            </ListItem>
            <ListItem>
              <ListItemText>Service XXX having frequent restarts</ListItemText>
            </ListItem>
          </List>
        </Typography>
      </CardContent>
