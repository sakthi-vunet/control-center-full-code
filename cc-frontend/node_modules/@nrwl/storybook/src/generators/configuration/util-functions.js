...
function addAngularStorybookTask(tree, projectName, buildTargetForAngularProjects) {
    const projectConfig = (0, devkit_1.readProjectConfiguration)(tree, projectName);
    projectConfig.targets['storybook'] = {
        ...
        options: {
            ...
            browserTarget: `${projectName}:${buildTargetForAngularProjects ? 'build' : 'build-storybook'}`,
            compodoc: false,
        },
        configurations: {
            ci: {
...
function createProjectStorybookDir(tree, projectName, uiFramework, js, tsConfiguration) {
