(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('object-assign'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'object-assign', 'react-dom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactBeautifulDnd = {}, global.React, global.require$$1, global.ReactDOM));
})(this, (function (exports, React, require$$1, ReactDOM) { 'use strict';
  ...
  var isDisabledFlag = '__@react-forked/dnd-disable-dev-warnings';
  ...
  var RbdInvariant = function (_Error) {
    _inheritsLoose(RbdInvariant, _Error);
  ...
  */
  ...
  var isEqual$2 = function isEqual(point1, point2) {
  ...
  var toDroppableList = memoizeOne(function (droppables) {
    return Object.values(droppables);
  });
  var toDraggableList = memoizeOne(function (draggables) {
    return Object.values(draggables);
  });
  ...
  var moveToNextCombine = (function (_ref) {
    ...
    var indexOfClosest = withoutDraggable.findIndex(function (d) {
  ...
  function calculateReorderImpact(_ref2) {
    ...
    var match = insideDestination.find(function (item) {
  ...
  var getReorderImpact = (function (_ref2) {
    ...
    var withoutDragging = removeDraggableFromList(draggable, insideDestination);
    var closest = withoutDragging.find(function (child) {
  ...
  var getCombineImpact = (function (_ref) {
    ...
    var targetEnd = targetRect[axis.end];
    var withoutDragging = removeDraggableFromList(draggable, insideDestination);
    var combineWith = withoutDragging.find(function (child) {
      var id = child.descriptor.id;
  ...
  var publishWhileDraggingInVirtual = (function (_ref) {
    ...
    var draggingState = _extends({}, state, {
      phase: 'DRAGGING',
      impact: impact,
    ...
    var dropPending = _extends({}, draggingState, {
      phase: 'DROP_PENDING',
      reason: state.reason,
      isWaiting: false
    });
  ...
  var reducer = (function (state, action) {
    ...
    if (action.type === 'MOVE') {
      ...
      if (isEqual$2(_clientSelection, state.current.client.selection)) {
        return state;
      }
    ...
    if (action.type === 'MOVE_BY_WINDOW_SCROLL') {
      ...
      if (isEqual$2(state.viewport.scroll.current, _newScroll)) {
        return removeScrollJumpRequest(state);
      }
  ...
  var moveTo = function moveTo(offset) {
    return isEqual$2(offset, origin) ? undefined : "translate(" + offset.x + "px, " + offset.y + "px)";
  };
  ...
  var dropMiddleware = function dropMiddleware(_ref) {
    var getState = _ref.getState,
        dispatch = _ref.dispatch;
    return function (next) {
      return function (action) {
        ...
        var isAnimationRequired = !isEqual$2(state.current.client.offset, newHomeClientOffset) || Boolean(result.combine);
  ...
  var dropAnimationFinishMiddleware = function dropAnimationFinishMiddleware(store) {
    return function (next) {
      return function (action) {
  ...
  var dropAnimationFlushOnScrollMiddleware = function dropAnimationFlushOnScrollMiddleware(store) {
    var unbind = null;
    var frameId = null;
  ...
  function findDragHandle(contextId, draggableId) {
    ...
    var possible = querySelectorAll(document, selector);
    ...
    var handle = possible.find(function (el) {
  ...
  function createRegistry() {
    ...
    var draggableAPI = {
      ...
      getAllByType: function getAllByType(type) {
        return Object.values(entries.draggables).filter(function (entry) {
    ...
    var droppableAPI = {
      ...
      getAllByType: function getAllByType(type) {
        return Object.values(entries.droppables).filter(function (entry) {
          return entry.descriptor.type === type;
        });
      }
    };
  ...
  var getId = function getId(contextId) {
    return "rfd-announcement-" + contextId;
  };
  ...
  function isAnInteractiveElement(parent, current) {
    ...
    var hasAnInteractiveTag = interactiveTagNames.includes(current.tagName.toLowerCase());
  ...
  var supportedMatchesName = function () {
    ...
    var value = candidates.find(function (name) {
  ...
  function findDraggable(contextId, draggableId) {
    ...
    var possible = querySelectorAll(document, selector);
    var draggable$1 = possible.find(function (el) {
  ...
  function useSensorMarshal(_ref4) {
    ...
    var isLockClaimed = useCallback(function () {
      return lockAPI.isClaimed();
    }, [lockAPI]);
  ...
  var Draggable = function Draggable(props) {
    ...
    var provided = useMemo(function () {
      ...
      var onTransitionEnd = mapped.type === 'DRAGGING' && mapped.dropping ? onMoveEnd : undefined;
      var result = {
        innerRef: setRef,
        draggableProps: {
  ...
  var Droppable = function Droppable(props) {
    ...
    var placeholder = useMemo(function () {
      return React__default["default"].createElement(AnimateInOut, {
