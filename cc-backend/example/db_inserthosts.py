...
# insert host data into the host table
...
def insert_hosts(host_item):
    ...
    # execute insert table commmand
    id = con.execute('INSERT INTO hosts(name,description,ip_address,host_type,labels,details) VALUES ("' +
                     host_item['name']+'","'+host_item['description']+'","'+host_item['Ipaddress']+'","'+host_item['host_type']+'",'+"'"+temp+"'"+",'"+details+"')")
